...
public class BuilderManager {
    ...
    static TextOutsideCircleButton.Builder getTextOutsideCircleButtonBuilderWithDifferentPieceColor(int text) {
        return new TextOutsideCircleButton.Builder()
                .normalImageRes(getImageResource())
                .normalTextRes(text)
                .pieceColor(Color.WHITE);
    ...
    static HamButton.Builder getHamButtonBuilderWithDifferentPieceColor(int text,int text2) {
        return new HamButton.Builder()
                .normalImageRes(getImageResource2())
                .normalTextRes(text)
                .subNormalTextRes(text2)
                .pieceColor(Color.WHITE);
    }
